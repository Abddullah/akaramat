...
import AddInvestorBody from '../Component/AddInvestorBody';
import Ionicons from 'react-native-vector-icons/Ionicons';

class AddInvestorMoney extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.addInvestorMoney}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    {/* <AddInvestorBody rout="AddInvestorBody"/> */}
                </View>
                {/* //////////////////////////////////////Projects////////////////////////////////////// */}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddInvestorMoney);

...
class MyInboxBody extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    _onRefreshTasker() {
        ...
        else if (this.props.rout === "MyInbox") {
            console.log("MyInbox")
            uri = "https://demo.akaratmisr.com:443/" + this.props.str.language + "/api/mailbox/user/getInboxEmail/10/0"
        }
        else if (this.props.rout === "inbMesToRep") {
            console.log("inbMesToRep")
            uri = "https://demo.akaratmisr.com:443/" + this.props.str.language + "/api/mailbox/user/getRepInboxEmail/10/0"
        }
    ...
    _onEndReached() {
        ...
        if (this.props.rout === "MyInbox") {
            let uri = "https://demo.akaratmisr.com:443/" + this.props.str.language + "/api/mailbox/user/getInboxEmail/10/" + this.state.page
    ...
    reply(sender_email) {
        Actions.createMessage({sender_email_for_Inbox:sender_email,inbox:true})
    }
                                                    ...
                                                    <View
                                                        ...
                                                        <View style={{
                                                            ...
                                                            <View style={{ flex: 2, backgroundColor: "#f8f1f1", padding: "2%" }}>
                                                                {(this.props.rout === "MyInbox") ? (
                                                                    <TouchableOpacity style={{ position: "absolute", zIndex: 1, right: 5 }}
                                                                        onPress={()=>this.reply(iAdded.sender_email)}
                                                                    >
                                                                        <Entypo name='reply' style={{ color: "#969696", fontWeight: "bold", fontSize: 23, }} />
                                                                    </TouchableOpacity>
                                                                ) :
                                                                    (null)
                                                                }
...
export default connect(mapStateToProps, mapDispatchToProps)(MyInboxBody);

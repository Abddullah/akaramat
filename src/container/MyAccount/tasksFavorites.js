...
class TasksFavorites extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.favoritesTasks}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(TasksFavorites);

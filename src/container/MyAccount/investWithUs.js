...
import InvestBody from '../../Component/investBody';
import Ionicons from 'react-native-vector-icons/Ionicons';

class InvestWithUs extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.investors}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    <InvestBody rout="agentFavorites"/>
                </View>
                {/* //////////////////////////////////////Projects////////////////////////////////////// */}
...
export default connect(mapStateToProps, mapDispatchToProps)(InvestWithUs);

...
import RequestsRepresent from '../../Component/RequestsRepresent';

class AllRequestsinCity extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.allrequestInMyCity}</Text>
                        {/* <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.propertiescategories.toUpperCase()}</Text> */}
                    </View>
                    {/* <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>All Properties I Added</Text>
                    </View> */}
                </View>
                {/* //////////////////////////////////////body////////////////////////////////////// */}
                <View style={{ flex: 8, width: "100%", }}>
                    <RequestsRepresent rout="allRequests" />
                </View>
                {/* //////////////////////////////////////Projects////////////////////////////////////// */}
...
export default connect(mapStateToProps, mapDispatchToProps)(AllRequestsinCity);

...
import CreateMessageBody from '../../Component/createMessageBody';
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.createMessage}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    <CreateMessageBody rout="outBoxBody" sender_email_for_Inbox={this.props.sender_email_for_Inbox}/>

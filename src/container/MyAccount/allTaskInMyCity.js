...
import RequestsRepresentTask from '../../Component/RequestsRepresentTask';
import Ionicons from 'react-native-vector-icons/Ionicons';

class AllTaskInCity extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.allTaskInMyCity}</Text>
                ...
                <RequestsRepresentTask rout="allTaskInCity"/>
                </View>
                {/* //////////////////////////////////////Projects////////////////////////////////////// */}
...
export default connect(mapStateToProps, mapDispatchToProps)(AllTaskInCity);

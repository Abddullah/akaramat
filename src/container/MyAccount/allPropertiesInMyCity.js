...
class AllPropsInCity extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.allpropertiesInMyCity}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    ...
                    <RequestsRepresent rout="allProperties" />
                </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(AllPropsInCity);

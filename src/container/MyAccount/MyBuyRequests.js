...
class MyBuyRequests extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.mybuyrequests}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    {(this.props.searchRequest) ?
                        (
                            <Requests rout="MyBuyRequestsSearch" searchRequest={this.props.searchRequest} keywords={this.props.keywords} />) :
                        <Requests rout="MyBuyRequests" />
                    }
                </View>
                {/* //////////////////////////////////////Projects////////////////////////////////////// */}
...
export default connect(mapStateToProps, mapDispatchToProps)(MyBuyRequests);

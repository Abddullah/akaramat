...
class TaskIAppliedFor extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ width: "90%", flexDirection: "row", marginTop: "7%" }}>
                        ...
                        <Text style={{ color: "#ffff", fontWeight: "bold", fontSize: 16 }}>{this.props.str.TaskIAppliedFor}</Text>
                ...
                <View style={{ flex: 8, width: "100%", }}>
                    {
                        (this.props.userDetails.user_type === "4") ?
                            (
                                <RequestsTasker rout="TaskIAppliedFor" />
                            ) :
                            (
...
export default connect(mapStateToProps, mapDispatchToProps)(TaskIAppliedFor);
